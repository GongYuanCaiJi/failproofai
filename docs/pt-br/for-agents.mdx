---
title: "Para agentes"
description: "Adicione o conhecimento do Failproof AI ao seu agente de programação em um único comando. Funciona com Claude Code, Cursor, Windsurf e muito mais."
---

Adicione a referência completa do Failproof AI ao seu agente de programação em um único comando. Funciona com Claude Code, Cursor, Windsurf e qualquer outro agente que suporte skills.
...
## O que a skill abrange

| Área | O que está incluído |
|------|---------------------|
| Policies | Nomes de policies integradas, tipos de eventos, parâmetros, habilitar/desabilitar |
...
O Mintlify gera o `llms.txt` a partir de todas as páginas da navegação. A documentação do Failproof AI cobre a API completa — cada policy, opção e exemplo está incluído. Se você encontrar algo faltando, o conteúdo fonte está em `https://docs.befailproof.ai/llms-full.txt`.

Para contexto direcionado, faça referência diretamente a uma página específica:
