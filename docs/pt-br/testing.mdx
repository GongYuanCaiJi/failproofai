...
__tests__/e2e/
  helpers/
    ...
    payloads.ts         # Fábricas de payloads fiéis ao Claude para cada tipo de evento
  hooks/
...
// env.cwd    - diretório temporário; passe como payload.cwd para usar .failproofai/policies-config.json
// env.home   - home dir isolada; sem vazamento do ~/.failproofai real
