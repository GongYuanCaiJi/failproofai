...
__tests__/e2e/
  helpers/
    hook-runner.ts      # Inicializa o binário, envia payload JSON, captura código de saída + stdout + stderr
...
// env.home   - diretório home isolado; sem vazamentos do ~/.failproofai real
