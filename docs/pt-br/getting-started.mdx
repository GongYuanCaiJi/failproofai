...
<Note>
As políticas rodam no seu processo local. Nenhum dado é enviado para um serviço remoto.
</Note>
...
A forma mais rápida de estabelecer padrões de qualidade em toda a equipe é a convenção de diretório `.failproofai/policies/`. Coloque arquivos de política nesse diretório e eles serão carregados automaticamente — sem flags, sem alterações de configuração, sem comandos de instalação.
