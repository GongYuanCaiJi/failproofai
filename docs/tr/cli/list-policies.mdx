...
Tüm ilkeleri durumları, yapılandırılmış parametreleri ve özel ilkelerle birlikte gösterir.
...
`policyParams` içindeki bilinmeyen anahtarlar burada işaretlenerek erken yazım hatalarını yakalamanızı sağlar.