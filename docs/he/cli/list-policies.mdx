...
description: "ראו אילו מדיניויות מופעלות, הפרמטרים שלהן, ומדיניויות מותאמות אישית"
---
...
מפתחות לא ידועים ב-`policyParams` מסומנים כאן כדי שתוכלו לתפוס כתבי יד מוקדם.