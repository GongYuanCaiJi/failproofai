...
מציג את כל המדיניויות עם המצב שלהן, הפרמטרים שהוגדרו, ומדיניויות מותאמות.
...
מפתחות לא ידועים ב־`policyParams` מסומנים כאן כדי שתוכל לתפוס כתיב שגוי בשלב מוקדם.