...
| 변수 | 설명 |
|----------|-------------|
| `FAILPROOF_API_URL` | `failproofai auth` 및 대시보드 인증 다이얼로그에서 사용하는 API 서버 기본 URL 재정의. 기본값은 `https://api.befailproof.ai`이며, 로컬 API 서버 실행 시 `http://localhost:8080`(또는 해당 주소)으로 설정. |
