...
antes de que se conviertan en incidentes. Sin latencia. Funciona localmente.
...
Confírmalo en el repositorio y todo el equipo lo obtiene en el siguiente pull.
...
MIT con [Commons Clause](https://commonsclause.com/) — gratuita para uso interno y personal; la reventa comercial de failproofai en sí requiere un acuerdo separado. Consulta [LICENSE](./LICENSE) para el texto completo.
