...
Claude Code और Codex में हुक करता है। लूप, खतरनाक कार्य, और गुप्त रिसाव को
...
> एक या किसी भी संयोजन के लिए हुक इंस्टॉल करें: `failproofai policies --install --cli opencode pi gemini` (या `--cli claude codex copilot cursor opencode pi gemini`)। `--cli` को छोड़ दें ताकि स्वचालित रूप से इंस्टॉल किए गए CLIs का पता लगे और संकेत दिया जाए। **GitHub Copilot CLI, Cursor Agent, OpenCode, Pi, और Gemini CLI सहायता बीटा में है — परीक्षण चल रहा है।**
...
30 अंतर्निर्मित नीतियां तुरंत सक्रिय हो जाती हैं। डैशबोर्ड `localhost:8020` पर।

---

## यह क्या रोकता है

| नीति | क्या अवरुद्ध करता है |
|---|---|
...
| `sanitize-api-keys` | API कुंजियां एजेंट संदर्भ में रिसना |
...
`.failproofai/policies/` में एक फाइल डालें — यह स्वचालित रूप से लोड होती है, किसी फ्लैग की आवश्यकता नहीं है।
...
| `instruct(message)` | इसे आगे जाने दें, लेकिन एजेंट के अगले प्रॉम्प्ट में संदर्भ जोड़ें |
...
आपका एजेंट प्रत्येक टूल कॉल को स्थानीय रूप से लॉग करता है। डैशबोर्ड दिखाता है कि क्या चला,
क्या अवरुद्ध किया गया, और नीति ने एजेंट को क्या बताया — इसलिए आप अनुमान नहीं लगा रहे हैं
...
| [कॉन्फ़िगरेशन](https://docs.befailproof.ai/configuration) | कॉन्फ़िग दायरे और मर्ज नियम |
...
[Commons Clause](https://commonsclause.com/) के साथ MIT — आंतरिक और व्यक्तिगत उपयोग के लिए मुफ्त; failproofai का वाणिज्यिक पुनर्विक्रय एक अलग समझौते की आवश्यकता है। पूर्ण पाठ के लिए [LICENSE](./LICENSE) देखें।
