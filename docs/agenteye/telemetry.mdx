...
description: "AgentEye Performance Metrics documentation."
---
...
AgentEye recognizes common model IDs automatically. If a window looks wrong, or you run a private model of your own, correct it or add one under **Settings**, in **model context windows**, and the fill readouts follow.
