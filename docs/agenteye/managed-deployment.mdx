...
The managed offering also operates the platform's evaluation pipeline, which scores agent activity against your evaluation criteria. See [Assistant](/agenteye/assistant) and [Evaluation Suite](/agenteye/evaluation-suite) for what these capabilities deliver.
