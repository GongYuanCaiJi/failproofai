...
description: "AgentEye CLI recipes for agents documentation."
---
...
- [Python SDK](/agenteye/python-sdk): send events into AgentEye so there is data for these recipes to query.
