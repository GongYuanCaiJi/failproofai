...
![A session detail view with the evaluation summary, per-dimension score bars, and reasoning text in the right rail](/agenteye/images/session-detail.png)
...
FailproofAI Observability also ships a **working reference evaluator** that
...
The evaluator is **your service** — FailproofAI Observability does not ship a
