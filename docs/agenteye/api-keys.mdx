---
title: "API Keys"
description: "API keys control who and what can reach your Failproof AI Observability server, so a collector can send events without ever gaining read or admin powers."
---
