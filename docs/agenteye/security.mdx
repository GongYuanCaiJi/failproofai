---
title: "Security"
description: "FailproofAI Observability Security documentation."
---
...
![The FailproofAI Observability sign-in screen, which sends a single-use code to your email](/agenteye/images/login.png)
