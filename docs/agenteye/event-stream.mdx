---
title: "Event Stream"
description: "AgentEye Event Stream documentation."
---
...
Behind it, your agents emit events through the SDK, the collector ships them to your AgentEye server, and the stream tails them as they arrive in infrastructure you control. When you want the rolled-up view instead of the raw trail, each run's events collapse into a single row on Sessions, one click away.
