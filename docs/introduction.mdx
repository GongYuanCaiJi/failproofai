---
title: "Introduction — Failure Handling for AI Agents"
description: "FailproofAI gives AI agents 39 built-in failure policies — catching loops, secret leaks, destructive tool calls, and more. One install. Runs locally."
---
...
Hooks and policies for **AI failure handling**, **error recovery**, and **LLM reliability** — keeping your AI agents reliable and running autonomously across **Claude Code**, **OpenAI Codex**, **GitHub Copilot**, **Cursor Agent**, **OpenCode**, **Pi**, **Gemini CLI**, and the **Agents SDK**.
...
FailproofAI solves this with **policies** — rules that hook into every agent tool call to **detect failures**, **mitigate them** (block, instruct, sanitize), and **alert you** when something needs attention. A local dashboard lets you review every tool call, agent failure, and recovery action afterward.
