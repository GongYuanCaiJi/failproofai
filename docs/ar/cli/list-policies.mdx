...
description: "انظر السياسات المفعلة وعواملها المعروفة والسياسات المخصصة"
---
...
يعرض جميع السياسات مع حالتها والعوامل المعروفة والسياسات المخصصة.
...
يتم وضع علامة على المفاتيح غير المعروفة في `policyParams` هنا حتى تتمكن من اكتشاف الأخطاء الإملائية مبكرًا.