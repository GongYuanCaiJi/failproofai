...
هذا هو الأمر المسجل في `settings.json` الخاص بـ Claude Code بواسطة `failproofai policies --install`. لا تقوم عادة باستدعاء هذا الأمر مباشرة.
...
| `1` | `deny` | حجب الإجراء - Claude سيرى سبب الرفض |
| `2` | `instruct` | حقن التوجيه في سياق Claude |
