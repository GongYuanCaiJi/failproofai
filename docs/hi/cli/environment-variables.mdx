---
title: पर्यावरण चर
description: "पर्यावरण चर के साथ failproofai के व्यवहार को कॉन्फ़िगर करें"
---
...
| `CLAUDE_PROJECTS_PATH` | Claude Code प्रोजेक्ट फ़ोल्डर को खोजने के स्थान को ओवरराइड करें |
| `FAILPROOFAI_DISABLE_PAGES=policies,projects` | छिपाने के लिए अल्पविराम-पृथक डैशबोर्ड पृष्ठ |
