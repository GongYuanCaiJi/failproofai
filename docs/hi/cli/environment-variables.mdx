...
| `CLAUDE_PROJECTS_PATH` | Claude Code प्रोजेक्ट फ़ोल्डर के स्थान को ओवरराइड करें |
| `FAILPROOFAI_DISABLE_PAGES=policies,projects` | कॉमा-अलग डैशबोर्ड पृष्ठ छिपाने के लिए |
| `FAILPROOFAI_ALLOWED_DEV_ORIGINS` | dev संसाधनों को एक्सेस करने के लिए अनुमत होस्ट/IP। `--allowed-origins` के समान। |
...
| चर | विवरण |
|----------|-------------|
| `FAILPROOFAI_TELEMETRY_DISABLED=1` | गुमनाम उपयोग टेलीमेट्री को अक्षम करें |
