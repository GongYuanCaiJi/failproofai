...
| फ्लैग | विवरण |
|------|-------------|
| `--scope user` | ग्लोबल सेटिंग्स से हटाएं (डिफ़ॉल्ट) |
| `--scope project` | प्रोजेक्ट सेटिंग्स से हटाएं |
| `--scope local` | लोकल सेटिंग्स से हटाएं |
...
- **विशिष्ट नाम** - उन नीतियों को अक्षम करता है लेकिन हुक इंस्टॉल रहते हैं

## उदाहरण

```bash
# सभी हुक्स को ग्लोबली हटाएं
failproofai policies --uninstall

# एक विशिष्ट नीति को अक्षम करें (हुक्स इंस्टॉल रहते हैं)
failproofai policies --uninstall block-sudo

# हर स्कोप से हुक्स को हटाएं
failproofai policies --uninstall --scope all

# कस्टम नीतियों पाथ को साफ़ करें
