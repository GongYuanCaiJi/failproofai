...
Supprime les entrées de hook failproofai du `settings.json` de Claude Code.
...
- **Sans nom de politique** — supprime toutes les entrées de hook failproofai du fichier de paramètres
- **Avec des noms spécifiques** — désactive ces politiques mais conserve les hooks installés
