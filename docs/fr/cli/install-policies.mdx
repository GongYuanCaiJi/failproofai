...
Inscrit des entrées de hook dans le fichier de paramètres de votre agent CLI installé (Claude Code, OpenAI Codex, ou GitHub Copilot CLI _(bêta)_) afin que failproofai intercepte les appels d'outils.
...
|------|-------------|
| `--cli claude\|codex\|copilot` | Agent(s) CLI pour lesquels installer ; séparés par des espaces (ex. `--cli claude codex copilot`) ou répétés. Omettez cet indicateur pour détecter automatiquement les CLI installés et afficher une invite. |
