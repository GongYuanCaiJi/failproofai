...
![L'écran de connexion AgentEye, qui envoie un code à usage unique à votre adresse email](/agenteye/images/login.png)
...
![La liste des sessions, une ligne par exécution, avec des indicateurs de statut et des badges de score d'évaluation](/agenteye/images/sessions-list.png)
...
![Un tableau de bord construit à partir de requêtes sauvegardées : une ligne d'événements par heure, un graphique à barres d'erreurs par type, un graphique en aire de latence et des tokens par modèle](/agenteye/images/dashboard-fleet.png)
