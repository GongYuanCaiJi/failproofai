...
Ajoutez la référence complète Failproof AI à votre agent de codage en une seule commande. Compatible avec Claude Code, Cursor, Windsurf, et tout autre agent prenant en charge les skills.
...
Mintlify génère `llms.txt` à partir de toutes les pages de la navigation. La documentation Failproof AI couvre l'API complète — chaque politique, option et exemple y est inclus. Si vous constatez qu'il manque quelque chose, la source est disponible à `https://docs.befailproof.ai/llms-full.txt`.
