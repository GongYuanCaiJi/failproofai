---
title: Tests
description: "Tests unitaires, tests E2E et helpers de test"
icon: flask-vial
---
...
__tests__/
  ...
  components/
    sessions-list.test.tsx        # Composant liste de sessions
    project-list.test.tsx         # Composant liste de projets
    ...
  lib/
    logger.test.ts
    paths.test.ts
...
Les tests E2E invoquent le vrai binaire `failproofai` en tant que sous-processus, envoient un payload JSON sur stdin et vérifient la sortie stdout ainsi que le code de sortie. Cela teste le chemin d'intégration complet qu'utilise Claude Code.
...
// env.cwd    - répertoire temp ; à passer comme payload.cwd pour utiliser .failproofai/policies-config.json
...
Consultez [Contributing](../CONTRIBUTING.md) pour la liste de contrôle pré-fusion complète.