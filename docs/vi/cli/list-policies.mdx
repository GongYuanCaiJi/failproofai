...
description: "Xem những chính sách nào được bật, các tham số của chúng và các chính sách tùy chỉnh"
---
...
Hiển thị tất cả các chính sách cùng với trạng thái, các tham số đã cấu hình và các chính sách tùy chỉnh của chúng.
...
Các khóa không xác định trong `policyParams` sẽ được đánh dấu ở đây để bạn có thể phát hiện những lỗi đánh máy sớm.